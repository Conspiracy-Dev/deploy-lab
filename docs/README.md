# DeployLab documentation

- [Project brief](PROJECT.md) — scope, architecture and acceptance constraints.
- [Figma UI kit plan](plans/ui-kit-figma.md) — approved scope, epic roadmap,
...
- [AI contour decisions](decisions/ai-contour.md) — durable reasons behind the
  provider, Skill, MCP, hook and tooling configuration.
- [UI kit architecture decision](decisions/ui-kit-architecture.md) — component
